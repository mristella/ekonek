    ...
    <footer className="bg-gray-50 border-t border-gray-200 text-black">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              A youth-led, open-access platform bridging changemakers with resources, networks, and opportunities to create lasting community impact.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-full">Subscribe</Button>
            </div>
          </div>
        ...
        <div className="mt-10 border-t border-gray-200 pt-6 text-center text-sm text-gray-600 flex flex-col sm:flex-row justify-center items-center gap-4">
          <span>© {new Date().getFullYear()} E-Konektado. All Rights Reserved.</span>
          <span>
            <Link href="/privacy" className="hover:text-orange-500">Privacy Policy</Link> | 
            <Link href="/terms" className="hover:text-orange-500 ml-1">Terms of Use</Link>
          </span>
        </div>
      </div>
    </footer>
